...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchBorrowHistory(page = 1) {
    ...
    const borrowUrl = `https://localhost:44354/api/Books/borrow-history?UserId=${encodeURI(
      userId
    )}&serialnumber=${serialNumber}&overdue=${overdue}&IsReturned=${isReturned}&startDate=${startDate}&endDate=${endDate}&Department=${department}&School=${school}&pageNumber=${page}&pageSize=${pageSize}&IsOnline=true`;
